...
ROMAJI_INFO romaKeys[] = {
	...
	[MOJI_LKAGI] = {KEY_Z,KEY_LEFTBRACE,0}, /* MOJI_LKAGI 94 */
	[MOJI_RKAGI] = {KEY_Z,KEY_RIGHTBRACE,0}, /* MOJI_RKAGI 95 */
	...
	[MOJI_LKAKKO] = {KEY_LEFTBRACE,0,0}, /* MOJI_LKAGI 118 */
	[MOJI_RKAKKO] = {KEY_RIGHTBRACE,0,0} /* MOJI_RKAGI 119 */
};
