...
ROMAJI_INFO romaKeys[] = {
	...
	[MOJI_TILDE] = {KEY_LEFTSHIFT,KEY_3,0}, /* MOJI_TILDE 93 */
	[MOJI_LKAGI] = {KEY_LEFTBRACE,0,0}, /* MOJI_LKAGI 94 */
	[MOJI_RKAGI] = {KEY_RIGHTBRACE,0,0}, /* MOJI_RKAGI 95 */
	[MOJI_LBRACKET] = {KEY_LEFTSHIFT,KEY_LEFTBRACE,0}, /* MOJI_LBRACKET 96 */
	[MOJI_RBRACKET] = {KEY_LEFTSHIFT,KEY_RIGHTBRACE,0}, /* MOJI_RBRACKET 97 */
	[MOJI_LPAREN] = {KEY_LEFTSHIFT,KEY_9,0}, /* MOJI_LPAREN 98 */
	[MOJI_RPAREN] = {KEY_LEFTSHIFT,KEY_0,0}, /* MOJI_RPAREN 99 */
...
/*
Boolean decrement_timer_time(long millis) {
	if (_event_timer <= 0) {
		_event_timer = 0l;
		return FALSE;
	}
